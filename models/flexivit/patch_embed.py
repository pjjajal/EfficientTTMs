# Code borrowed from flexivit_pytorch (https://github.com/bwconrad/flexivit)
# Minor modifications made to the original source code
# Changed from: functorch.vmap -> torch.vmap
...
# Getting rid of functorch,  use torch instead
